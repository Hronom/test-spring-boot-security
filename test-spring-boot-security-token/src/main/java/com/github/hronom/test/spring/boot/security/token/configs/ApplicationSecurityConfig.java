...
import com.github.hronom.test.spring.boot.security.token.configs.custom.objects.CustomAuthenticationProvider;
import com.github.hronom.test.spring.boot.security.token.configs.custom.objects.RestAuthenticationEntryPoint;
import com.github.hronom.test.spring.boot.security.token.filters.CustomTokenAuthenticationFilter;
import com.github.hronom.test.spring.boot.security.token.filters.CustomUsernamePasswordAuthenticationFilter;
import com.github.hronom.test.spring.boot.security.token.handlers.CustomAccessDeniedHandler;
import com.github.hronom.test.spring.boot.security.token.handlers.CustomAuthenticationSuccessHandler;
import com.github.hronom.test.spring.boot.security.token.handlers.CustomLogoutSuccessHandler;
import com.github.hronom.test.spring.boot.security.token.handlers.CustomUrlAuthenticationFailureHandler;
